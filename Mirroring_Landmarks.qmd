...
Following Green, Bloom, and Kulbersh (2017) I will use the Nasion, Basion, and Incisive Foramen landmarks to define the MSP (fig.2). Landmarking protocol can be found under the "Landmark COnfiguration" section on the [`Morphometrics`](Morph.qmd) page.
